...
const BASELINE_EXECUTOR_TOOL_GROUPS: ReadonlyArray<ReadonlyArray<ExecutorBackedToolFactory>> = [
  [createWebSearchTool, createVisitWebpageTool, createExecuteCodeTool],
  [createShareArtifactTool, createEditArtifactTool, createGenerateImageTool],
  [createOracleTool, createChronicleReadTool, createChronicleAppendTool],
  [createQuestStartTool, createSubquestStartTool, createQuestSnoozeTool],
];
